...
index_trade = stock_tick.history(period="2y")
index_trade.drop(['Dividends', 'Stock Splits'], axis=1, inplace=True)
index_trade['Close Change'] = index_trade.pct_change()['Close']
...
updates_index_trade_fun_an = pd.concat([index_trade_fun_an_past.loc[:'2019-12-31'], index_trade_fun_an.loc['2020-01-01':]])
...
all_features, all_y = finan.generator(tec_an=index_trade, fun_an= updates_index_trade_fun_an, start = start, end = end, days_an = 45)
...
normalized_dir_y = "normalized/"+stock_name+"/y_"+version+".pkl"
